...
#SBATCH --job-name=qc05_1_LDSC_munge_IN_ALL_%a
...
#SBATCH --array=1-12
#SBATCH --output=/scratch/project_2007428/projects/prj_001_cost_gwas/logs/qc05_01_ldsc_munge_IN_ALL_%a.log
#SBATCH --error=/scratch/project_2007428/projects/prj_001_cost_gwas/logs/qc05_01_ldsc_munge_IN_ALL_%a.log
