...
#SBATCH --job-name=qc05_02_LDSC_run_DRUG_ALL
#SBATCH --time=3-00:00:00
#SBATCH --partition=small
#SBATCH --ntasks=1
#SBATCH --mem-per-cpu=64G
#SBATCH --account=project_2007428
#SBATCH --output=/scratch/project_2007428/projects/prj_001_cost_gwas/logs/qc05_02_ldsc_run_DRUG_ALL.log
#SBATCH --error=/scratch/project_2007428/projects/prj_001_cost_gwas/logs/qc05_02_ldsc_run_DRUG_ALL.log
...
for startingFile in "${allFiles[@]}"; do
    ...
    /projappl/project_2007428/software/ldsc/ldsc.py \
        ...
        --out /scratch/project_2007428/projects/prj_001_cost_gwas/processing/ldsc_intermediate_files/DRUG_ALL/${cohort}_DRUG_ALL_ldsc_corr
