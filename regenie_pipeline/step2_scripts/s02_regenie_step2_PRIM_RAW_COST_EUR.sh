...
#SBATCH --job-name=a02_REGENIE_step_2_GWAS_PRIM_RAW_COST_EUR_%a
...
#SBATCH --array=1-23
#SBATCH --output=/scratch/project_2007428/projects/prj_001_cost_gwas/logs/regenie_logs/a02_regenie_step2_PRIM_RAW_COST_EUR_%A_%a.log
#SBATCH --error=/scratch/project_2007428/projects/prj_001_cost_gwas/logs/regenie_logs/a02_regenie_step2_PRIM_RAW_COST_EUR_%A_%a.log
