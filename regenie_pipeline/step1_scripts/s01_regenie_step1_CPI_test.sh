...
#SBATCH --job-name=REGENIE_step_1_GWAS_CPI_tests
#SBATCH --time=3-00:00:00
#SBATCH --partition=small
#SBATCH --ntasks=10
#SBATCH --mem-per-cpu=32G
#SBATCH --account=project_2007428
#SBATCH --output=/scratch/project_2007428/projects/prj_001_cost_gwas/logs/a01_regenie_step1_CPI_tests.log
#SBATCH --error=/scratch/project_2007428/projects/prj_001_cost_gwas/logs/a01_regenie_step1_CPI_tests.log
...
phenotype_file="FINAL_CPI_test_phenotype_frame_REGENIE.tsv"
...
tmpDir_for_lowmem="/scratch/project_2007428/projects/prj_001_cost_gwas/tmpdir/regenie_tmp_preds/HES_CPI_test/"
mkdir -p ${tmpDir_for_lowmem}

### Output prefix

out_prefix="/scratch/project_2007428/projects/prj_001_cost_gwas/outputs/regenie/step1_output/HES_CPI_test/"
mkdir -p ${out_prefix}
